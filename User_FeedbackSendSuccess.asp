...
<title>Gửi Feedback Thành Công</title>
<!-- InstanceEndEditable -->
<!-- InstanceBeginEditable name="head" -->
<!-- InstanceEndEditable -->
</head><!-- InstanceBeginEditable name="body" -->
<body>
<!-- InstanceEndEditable -->
<header id="header">
  <!--header-->
  <div class="header-middle">
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-4" style="color: #B4B1AB;font-family: abel; font-size:27px; text-transform: uppercase;"><span style="color:#FE980F;">MAXSPEED's</span>LAPTOP-SHOPPER</div>
        <div class="col-sm-8">
    ...
    <div class="row">
          ...
          <div class="brands_products">
            ...
            <div class="brands-name">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="Admin_Home.asp">Trang Chủ Admin</a><a href="Admin_ManageBrand.asp">Quản Lý Thương Hiệu</a><a href="Admin_ManageProduct.asp">Quản Lý Sản Phẩm</a><a href="#">Quản Lý Bình Luận</a><a href="Admin_ManageFeedback.asp">Quản Lý Phản Hồi</a><a href="Admin_ManageEventAndNews.asp">Quản Lý Tin Tức &amp; Sự Kiện</a><a href="Admin_ManageUser.asp">Quản Lý Thành Viên</a></li>
              </ul>
            </div>
          </div>
          <!--/brands_products-->
      ...
      <div class="col-sm-9 padding-right">
        <!-- InstanceBeginEditable name="Content" -->
          <h2 class="title text-center">Gửi Feedback Thành Công</h2>
          <div class="col-sm-12">
            <table width="100%" border="0" align="center">
              <tr>
                <td align="center" valign="middle"><strong><a href="User_Feedback.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "FeedbackMemberID=" & Session("MM_Username") %>" class="btn search">Trở Về Trang Danh Sách Phản Hồi</a></strong></td>
              </tr>
            </table>
          </div>
        <!-- InstanceEndEditable -->
...
<footer id="footer">
      ...
      <div class="row">
        <div class="col-sm-5">
          <div class="companyinfo">
            <h2><span>MAXSPEED's</span>LAPTOP-SHOPPER</h2>
            <p>Đến với cửa hàng laptop của MAXSPEED chúng tôi là sự lựa chọn đúng đắn!</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-2">
          <div class="single-widget">
            ...
            <ul class="nav nav-pills nav-stacked">
              <li><a href="#">Về MAXSPEED</a></li>
              <li><a href="#">Về LAPTOP-SHOPPER</a></li>
  ...
  <div class="footer-bottom">
    <div class="container">
      <div class="row">
        <p class="pull-left">Copyright © 2016 MAXSPEED's LAPTOP-SHOPPER Inc. All rights reserved.</p>
        <p class="pull-right">Designed by<span>Nhóm 1 - MAXSPEED</span></p>
      </div>
    </div>
  </div>
</footer>
