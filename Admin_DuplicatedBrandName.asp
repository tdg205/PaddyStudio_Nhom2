...
<title>Tên Thương Hiệu Bị Trùng</title>
<!-- InstanceEndEditable -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
                    ...
                    <h2 class="title text-center">Tên Thương Hiệu Bị Trùng</h2>
                    <div class="col-sm-12">
                    	<table width="100%" border="0" align="center">
                            <tr>
    							<td align="center" valign="middle"><strong><a href="javascript:history.back()" class="btn search">Trở Về Trang Trước</a></strong></td>
						  </tr>
						</table>
                    </div>
					<!-- InstanceEndEditable -->
