...
If (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "DELETE FROM dbo.tbProduct WHERE ProductID = ?"
...
%>
<%
Dim rsAdmin_ProductDetail__MMColParam
rsAdmin_ProductDetail__MMColParam = "1"
If (Request.QueryString("ProductID") <> "") Then 
  rsAdmin_ProductDetail__MMColParam = Request.QueryString("ProductID")
End If
%>
<%
Dim rsAdmin_ProductDetail
Dim rsAdmin_ProductDetail_cmd
Dim rsAdmin_ProductDetail_numRows

Set rsAdmin_ProductDetail_cmd = Server.CreateObject ("ADODB.Command")
rsAdmin_ProductDetail_cmd.ActiveConnection = MM_cn_STRING
rsAdmin_ProductDetail_cmd.CommandText = "SELECT * FROM dbo.tbProduct WHERE ProductID = ?" 
rsAdmin_ProductDetail_cmd.Prepared = true
rsAdmin_ProductDetail_cmd.Parameters.Append rsAdmin_ProductDetail_cmd.CreateParameter("param1", 5, 1, -1, rsAdmin_ProductDetail__MMColParam) ' adDouble

Set rsAdmin_ProductDetail = rsAdmin_ProductDetail_cmd.Execute
rsAdmin_ProductDetail_numRows = 0
%>
<%
Dim rsXoa__MMColParam
rsXoa__MMColParam = "1"
If (Request.QueryString("ProductID") <> "") Then 
  rsXoa__MMColParam = Request.QueryString("ProductID")
End If
%>
<%
Dim rsXoa
...
rsXoa_cmd.CommandText = "SELECT * FROM dbo.tbProduct WHERE ProductID = ?" 
...
%>
<%
rsAdmin_ProductDetail.Close()
Set rsAdmin_ProductDetail = Nothing
%>
<%
rsXoa.Close()
Set rsXoa = Nothing
