...
If (CStr(Request(MM_flag)) <> "") Then
  ...
  MM_dupKeyRedirect = "Admin_DuplicatedBrandName.asp"
  MM_dupKeyUsernameValue = CStr(Request.Form("BrandName"))
  Set MM_rsKey_cmd = Server.CreateObject ("ADODB.Command")
  MM_rsKey_cmd.ActiveConnection = MM_cn_STRING
  MM_rsKey_cmd.CommandText = "SELECT BrandName FROM dbo.tbBrand WHERE BrandName = ?"
...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.tbBrand (BrandName, BrandLogo, BrandDescription) VALUES (?, ?, ?)" 
    ...
    <div class="row">
      ...
      <div class="col-sm-9 padding-right">
        <!-- InstanceBeginEditable name="Content" -->
                    <h2 class="title text-center">Thêm Thương Hiệu</h2>
                    <div class="col-sm-12">
