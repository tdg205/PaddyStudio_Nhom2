...
%>
<%
Dim rsAdminAccountDetail
Dim rsAdminAccountDetail_cmd
Dim rsAdminAccountDetail_numRows

Set rsAdminAccountDetail_cmd = Server.CreateObject ("ADODB.Command")
rsAdminAccountDetail_cmd.ActiveConnection = MM_cn_STRING
rsAdminAccountDetail_cmd.CommandText = "SELECT * FROM dbo.tbUser WHERE UserID = ?" 
rsAdminAccountDetail_cmd.Prepared = true
rsAdminAccountDetail_cmd.Parameters.Append rsAdminAccountDetail_cmd.CreateParameter("param1", 200, 1, 20, rsAdminAccountDetail__MMColParam) ' adVarChar

Set rsAdminAccountDetail = rsAdminAccountDetail_cmd.Execute
rsAdminAccountDetail_numRows = 0
%>
<%
...
%>
<%
rsAdminAccountDetail.Close()
Set rsAdminAccountDetail = Nothing
%>
