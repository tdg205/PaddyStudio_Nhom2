...
%>
<%
Dim rsAdminFeedbackDetail__MMColParam
rsAdminFeedbackDetail__MMColParam = "1"
If (Request.QueryString("FeedbackID") <> "") Then 
  rsAdminFeedbackDetail__MMColParam = Request.QueryString("FeedbackID")
End If
%>
<%
Dim rsAdminFeedbackDetail
Dim rsAdminFeedbackDetail_cmd
Dim rsAdminFeedbackDetail_numRows

Set rsAdminFeedbackDetail_cmd = Server.CreateObject ("ADODB.Command")
rsAdminFeedbackDetail_cmd.ActiveConnection = MM_cn_STRING
rsAdminFeedbackDetail_cmd.CommandText = "SELECT * FROM dbo.tbFeedback WHERE FeedbackID = ?" 
rsAdminFeedbackDetail_cmd.Prepared = true
rsAdminFeedbackDetail_cmd.Parameters.Append rsAdminFeedbackDetail_cmd.CreateParameter("param1", 5, 1, -1, rsAdminFeedbackDetail__MMColParam) ' adDouble

Set rsAdminFeedbackDetail = rsAdminFeedbackDetail_cmd.Execute
rsAdminFeedbackDetail_numRows = 0
%>
<%
...
%>
<%
rsAdminFeedbackDetail.Close()
Set rsAdminFeedbackDetail = Nothing
%>
<%
rsFeedbackID.Close()
