    ...
    <div class="row">
      ...
      <div class="col-sm-9 padding-right">
        <!-- InstanceBeginEditable name="Content" -->
                    ...
                    <div class="col-sm-12">
                    	<h1 align="center">
                    		<div style="color: #B4B1AB;font-family: abel">
								<span style="color: #429DF1;">Paddy</span> Studio
                      		</div>
                 		</h1>
                        <p align="justify">Ngày nay, với sự phát triển của công nghệ và internet, các thiết bị truyền thống được thay thế bằng sự ra đời của hàng loạt các thiết bị công nghệ nhằm đáp ứng nhu cầu sử dụng công nghệ ngày càng cao của con người. Với sự đa dạng hóa của các thiết bị công nghệ, khách hàng sẽ có nhiều sự lựa chọn phù hợp thông qua các kiểu dáng và tính năng của sản phẩm.</p>
						<p align="justify">Laptop (hay còn gọi là máy tính xách tay) là một trong những thiết bị công nghệ phổ biến nhất trong đời sống hiện nay. Với việc sử dụng một chiếc máy laptop, người dùng sẽ chủ động và sắp xếp được thời gian làm việc của mình một cách dễ dàng và hợp lý. Giờ đây, việc xử lý công việc không bị bó hẹp trong không gian văn phòng, trước một chiếc máy tính case cồng kềnh nữa mà bất cứ nơi đâu tại nhà, quán café, công viên, bến xe buýt,… người dùng vẫn có thể linh hoạt làm việc mà không gặp trở ngại gì về dữ liệu, kiểm tra email hay vào mạng nội bộ công ty, xử lý công việc một cách hiệu quả. Các chức năng truy cập internet, wifi, chia sẻ không dây, được trang bị ngày càng hoàn thiện cho phép người dùng lướt web và chia sẻ dữ liệu mọi lúc mọi nơi. Đây chính là điểm mạnh nhất trong vai trò hàng đầu của laptop trong phục vụ đời sống con người.</p>
						<p align="justify"> Do trên thị trường hiện nay có quá nhiều sản phẩm laptop nên khách hàng không nắm bắt chi tiết sản phẩm cụ thể và không có thời gian đến từng cửa hàng tìm hiểu sản phẩm, chúng tôi quyết định thiết kế và xây dựng một website quảng cáo laptop với những sản phẩm đa dạng về mẫu mã và tính năng nhằm mục tiêu giúp khách hàng dễ dàng hơn trong việc lựa chọn những sản phẩm phù hợp cho mình.</p><br/>
                    </div>
					<!-- InstanceEndEditable -->
      </div>
    </div>
