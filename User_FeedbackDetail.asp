...
If (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    MM_editRedirectUrl = "User_FeedbackDeleteSuccess.asp"
    If (Request.QueryString <> "") Then
...
%>
<%
Dim rsFeedbackDetail__MMColParam
rsFeedbackDetail__MMColParam = "1"
If (Request.QueryString("FeedbackID") <> "") Then 
  rsFeedbackDetail__MMColParam = Request.QueryString("FeedbackID")
End If
%>
<%
Dim rsFeedbackDetail
Dim rsFeedbackDetail_cmd
Dim rsFeedbackDetail_numRows

Set rsFeedbackDetail_cmd = Server.CreateObject ("ADODB.Command")
rsFeedbackDetail_cmd.ActiveConnection = MM_cn_STRING
rsFeedbackDetail_cmd.CommandText = "SELECT * FROM dbo.tbFeedback WHERE FeedbackID = ?" 
rsFeedbackDetail_cmd.Prepared = true
rsFeedbackDetail_cmd.Parameters.Append rsFeedbackDetail_cmd.CreateParameter("param1", 5, 1, -1, rsFeedbackDetail__MMColParam) ' adDouble

Set rsFeedbackDetail = rsFeedbackDetail_cmd.Execute
rsFeedbackDetail_numRows = 0
%>
<%
Dim rsXoa__MMColParam
rsXoa__MMColParam = "1"
If (Request.QueryString("FeedbackID") <> "") Then 
  rsXoa__MMColParam = Request.QueryString("FeedbackID")
End If
%>
<%
Dim rsXoa
...
rsXoa_cmd.CommandText = "SELECT * FROM dbo.tbFeedback WHERE FeedbackID = ?" 
                    ...
                    <div class="col-sm-12">
                   		<form ACTION="<%=MM_editAction%>" id="form1" name="form1" method="POST">
        					...
        					<tr>
          						...
          						<td width="60%" align="left" valign="top"><input type="text" size="30%" value="<%=(rsFeedbackDetail.Fields.Item("FeedbackSubject").Value)%>" readonly/></td>
       						</tr>
                            <tr>
                                <td align="right" valign="top"><strong>Nội Dung: &nbsp;</strong></td>
                              	<td align="left" valign="top"><textarea rows="10" readonly><%=(rsFeedbackDetail.Fields.Item("FeedbackContent").Value)%></textarea></td>
                            </tr>
                            <tr>
                                <td align="right" valign="top"><strong>Admin Trả Lời: &nbsp;</strong></td>
                              	<td align="left" valign="top"><input type="text" value="<%=(rsFeedbackDetail.Fields.Item("FeedbackAdminReplyID").Value)%>" size="30%" readonly/></td>
                            </tr>
                            <tr>
                                <td align="right" valign="top"><strong>Nội Dung Trả Lời: &nbsp;</strong></td>
                              	<td align="left" valign="top"><textarea rows="10" readonly><%=(rsFeedbackDetail.Fields.Item("FeedbackReply").Value)%></textarea></td>
                            </tr>
                          <tr>
...
%>
<%
rsFeedbackDetail.Close()
Set rsFeedbackDetail = Nothing
%>
<%
rsFeedbackID.Close()
