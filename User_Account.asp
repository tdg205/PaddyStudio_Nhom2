...
<%
Dim rsAccountDetail
Dim rsAccountDetail_cmd
Dim rsAccountDetail_numRows

Set rsAccountDetail_cmd = Server.CreateObject ("ADODB.Command")
rsAccountDetail_cmd.ActiveConnection = MM_cn_STRING
rsAccountDetail_cmd.CommandText = "SELECT * FROM dbo.tbUser WHERE UserID = ?" 
rsAccountDetail_cmd.Prepared = true
rsAccountDetail_cmd.Parameters.Append rsAccountDetail_cmd.CreateParameter("param1", 200, 1, 20, rsAccountDetail__MMColParam) ' adVarChar

Set rsAccountDetail = rsAccountDetail_cmd.Execute
rsAccountDetail_numRows = 0
%>
<%
...
%>
<%
rsAccountDetail.Close()
Set rsAccountDetail = Nothing
%>
