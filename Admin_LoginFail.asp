...
If MM_valUsername <> "" Then
  ...
  MM_redirectLoginSuccess = "Admin_LoginSuccess.asp"
  MM_redirectLoginFailed = "Admin_LoginFail.asp"

  MM_loginSQL = "SELECT UserID, UserPassword"
  If MM_fldUserAuthorization <> "" Then MM_loginSQL = MM_loginSQL & "," & MM_fldUserAuthorization
  MM_loginSQL = MM_loginSQL & " FROM dbo.tbUser WHERE UserID = ? AND UserPassword = ? AND UserRole = 1"
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
                    ...
                    <h2 class="title text-center">Tên Đăng Nhập hoặc Mật Khẩu không đúng</h2>
                   		<div class="col-sm-12"><!--login form-->
							<form ACTION="<%=MM_LoginAction%>" METHOD="POST" id="formLogin" name="formLogin" onSubmit="return check()">
                            	<table width="100%" border="0" cellpadding="5" cellspacing="5">
                                    ...
                                    <tr>
    									<td align="right" valign="top"><input type="hidden" id="UserRole" name="UserRole" value="1" /></td>
