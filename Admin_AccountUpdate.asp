...
rsAdminAccountUpdate__MMColParam = "1aa"
If (Request.QueryString("UserID") <> "") Then 
  rsAdminAccountUpdate__MMColParam = Request.QueryString("UserID")
Else
	rsAdminAccountUpdate__MMColParam = Session("MM_Username")
End If
%>
<%
    ...
    <div class="row">
      ...
      <div class="col-sm-9 padding-right">
        <!-- InstanceBeginEditable name="Content" -->
					...
					<% If((Not rsAdminAccountUpdate.BOF) And (Not rsAdminAccountUpdate.EOF)) Then %>
