...
<%
Dim rsManageBrand
Dim rsManageBrand_cmd
Dim rsManageBrand_numRows

Set rsManageBrand_cmd = Server.CreateObject ("ADODB.Command")
rsManageBrand_cmd.ActiveConnection = MM_cn_STRING
rsManageBrand_cmd.CommandText = "SELECT * FROM dbo.tbBrand" 
rsManageBrand_cmd.Prepared = true

Set rsManageBrand = rsManageBrand_cmd.Execute
rsManageBrand_numRows = 0
%>
<%
...
Repeat2__numRows = 5
Repeat2__index = 0
rsManageBrand_numRows = rsManageBrand_numRows + Repeat2__numRows
%>
<%
...
rsManageBrand_total = rsManageBrand.RecordCount

' set the number of rows displayed on this page
If (rsManageBrand_numRows < 0) Then
  rsManageBrand_numRows = rsManageBrand_total
Elseif (rsManageBrand_numRows = 0) Then
  rsManageBrand_numRows = 1
End If

' set the first and last displayed record
rsManageBrand_first = 1
rsManageBrand_last  = rsManageBrand_first + rsManageBrand_numRows - 1

' if we have the correct record count, check the other stats
If (rsManageBrand_total <> -1) Then
  If (rsManageBrand_first > rsManageBrand_total) Then
    rsManageBrand_first = rsManageBrand_total
  End If
  If (rsManageBrand_last > rsManageBrand_total) Then
    rsManageBrand_last = rsManageBrand_total
  End If
  If (rsManageBrand_numRows > rsManageBrand_total) Then
    rsManageBrand_numRows = rsManageBrand_total
  End If
End If
%>
...
Set MM_rs    = rsManageBrand
MM_rsCount   = rsManageBrand_total
MM_size      = rsManageBrand_numRows
MM_uniqueCol = ""
MM_paramName = ""
MM_offset = 0
MM_atTotal = false
...
' set the first and last displayed record
rsManageBrand_first = MM_offset + 1
rsManageBrand_last  = MM_offset + MM_size

If (MM_rsCount <> -1) Then
  If (rsManageBrand_first > MM_rsCount) Then
    rsManageBrand_first = MM_rsCount
  End If
  If (rsManageBrand_last > MM_rsCount) Then
    rsManageBrand_last = MM_rsCount
  End If
End If
