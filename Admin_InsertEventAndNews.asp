...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO dbo.tbEventAndNews (EventSummary, EventContent, EventDuration, EventImage) VALUES (?, ?, ?, ?)" 
    ...
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param3", 202, 1, 100, Request.Form("EventDuration")) ' adVarWChar
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param4", 201, 1, 200, Request.Form("EventImage")) ' adLongVarChar
    MM_editCmd.Execute
...
<title>Thêm Tin Tức &amp; Sự Kiện</title>
<STYLE type="text/css">
.showMsg {
	font-family: verdana;
	font-size: 10px;
		...
		<form ACTION="<%=MM_editAction%>" id="form1" name="form1" method="POST" onSubmit="return check()">
		  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" bordercolor="#FFFFFF">
				<tr>
					...
					<td width="60%" align="left" valign="top"><input id="EventSummary" name="EventSummary" type="text" size="32"/>
						<br/>
				...
				<tr>
					...
					<td align="left" valign="top"><textarea id="EventContent" name="EventContent" cols="32" rows="15"></textarea>
						<br/>
				...
				<tr>
					...
					<td align="left" valign="top"><input id="EventDuration" name="EventDuration" type="text" size="32"/>
						<br/>
